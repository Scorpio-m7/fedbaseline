...
if __name__ == "__main__":
    ...
    mnist_iid_model = federated_learning_fedavg(copy.deepcopy(net_MNIST), trainloader_mnist.dataset,testloader_mnist, "MNIST",num_clients, epochs_per_round, num_rounds,malicious_ratio)

    print("Training MNIST on Non-IID")
    mnist_noniid_model = federated_learning_fedavg(copy.deepcopy(net_MNIST), trainloader_mnist.dataset,testloader_mnist,"MNIST", num_clients, epochs_per_round, num_rounds,malicious_ratio, noniid=True)

    print("Training CIFAR10 on IID")
    cifar10_iid_model = federated_learning_fedavg(copy.deepcopy(net_CIFAR10), trainloader_cifar.dataset, testloader_cifar,"CIFAR10",num_clients, epochs_per_round, num_rounds,malicious_ratio)
    
    print("Training CIFAR10 on Non-IID")
    cifar10_noniid_model = federated_learning_fedavg(copy.deepcopy(net_CIFAR10), trainloader_cifar.dataset, testloader_cifar,"CIFAR10",num_clients, epochs_per_round, num_rounds,malicious_ratio, noniid=True)
    
    """print("Training enhanced_CIFAR10 on IID") 
    cifar10_iid_model = federated_learning_fedavg(copy.deepcopy(net_enhanced_CIFAR10), trainloader_enhanced_cifar.dataset, num_clients, epochs_per_round, num_rounds,malicious_ratio)
    ...
    cifar10_noniid_model = federated_learning_fedavg(copy.deepcopy(net_CIFAR10), trainloader_enhanced_cifar.dataset, num_clients, epochs_per_round, num_rounds,malicious_ratio, noniid=True)
